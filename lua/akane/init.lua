...
local set_groups_hl = function ()
  local groups = {
    ...
    LspType           = { link = 'Type' },
    LspClass          = { fg = palette.line },
    LspEnum           = { fg = palette.indian_red },
    LspInterface      = { fg = palette.blue },
    LspStruct         = { fg = palette.cyan },
    LspTypeParameter  = { fg = palette.line_nr },
    LspParameter      = { fg = palette.cursor_line_nr },
    ...
    LspRegexp         = { fg = palette.green },
    LspOperator       = { link = 'Operator' },
    LspDeclaration    = { fg = palette.pink },
    ...
    LspDefaultLibrary = { fg = palette.indian_red },
