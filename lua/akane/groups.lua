...
M.set_groups_hl = function(palette)
  ...
  local groups = {
    ...
    -- Blink.cmp
    BlinkCmpLabelMatch = { fg = blue, bg = "NONE", bold = true },
    ...
    BlinkCmpKindField = { fg = bg1, bg = indian_red },
    BlinkCmpKindProperty = { fg = bg1, bg = indian_red },
    BlinkCmpKindEvent = { fg = bg1, bg = indian_red },
    BlinkCmpKindText = { fg = bg1, bg = green },
    BlinkCmpKindEnum = { fg = bg1, bg = green },
    BlinkCmpKindKeyword = { fg = bg1, bg = green },
    BlinkCmpKindConstant = { fg = bg1, bg = orange },
    BlinkCmpKindConstructor = { fg = bg1, bg = orange },
    BlinkCmpKindReference = { fg = bg1, bg = orange },
    BlinkCmpKindFunction = { fg = bg1, bg = purple },
    BlinkCmpKindStruct = { fg = bg1, bg = purple },
    BlinkCmpKindClass = { fg = bg1, bg = purple },
    BlinkCmpKindModule = { fg = bg1, bg = purple },
    BlinkCmpKindOperator = { fg = bg1, bg = purple },
    BlinkCmpKindVariable = { fg = bg1, bg = fg },
    BlinkCmpKindFile = { fg = bg1, bg = fg },
    BlinkCmpKindUnit = { fg = bg1, bg = yellow },
    BlinkCmpKindSnippet = { fg = bg1, bg = yellow },
    BlinkCmpKindFolder = { fg = bg1, bg = yellow },
    BlinkCmpKindMethod = { fg = bg1, bg = blue },
    BlinkCmpKindValue = { fg = bg1, bg = blue },
    BlinkCmpKindEnumMember = { fg = bg1, bg = blue },
    BlinkCmpKindInterface = { fg = bg1, bg = cyan },
    BlinkCmpKindColor = { fg = bg1, bg = cyan },
    BlinkCmpKindTypeParameter = { fg = bg1, bg = cyan },
